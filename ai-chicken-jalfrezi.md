...
### **Restaurant-Style Spicy Chicken Jalfrezi**

*   **Prep time:** 30 mins (+ 1 hr marination)
*   **Cook time:** 45 mins
*   **Serves:** 4
...
#### **The Marinade**
*   **Chicken:** 1.2 kg (approx. 2.5 lbs) chicken thigh pieces (breasts are too lean; thighs keep better 
moisture).
...
*   **Onions:** 2 large yellow onions, sliced into thin rings (keep the skin on).
*   **Tomatoes:** 4 medium tomatoes (blended smooth).
*   **Capsicum:** 2-3 bell peppers (green or red), cut into 1-inch strips. Do not grate them; you want distinct 
pieces.
*   **Garlic:** 1 tbsp fresh garlic cloves, peeled (for the finish).
*   **Curry Leaves:** 1 sprig, chopped (optional but traditional).
*   **Ghee:** 4 tbsp (essential for the restaurant mouthfeel).
...
*   In a large, heavy-bottomed pot (or a *karahi*), heat **2 tbsp Ghee** over medium-low heat.
*   Add the **onion rings**. Fry until deep golden brown. Do not rush this. If the onions are pale, the curry 
will lack depth.
*   Add the **grated ginger** and **tomato paste**. Fry until the oil separates and the mixture turns dark red. 
You want to remove the raw tomato smell.
*   Add **1 tbsp vinegar** and fry for 10 seconds. This creates the base acidity.

#### **3. Sear and Cook the Chicken**
*   Increase heat to medium-high.
*   Add the **marinated chicken** in batches. Do not overcrowd the pot.
*   Let the chicken sear undisturbed for 3-4 minutes to get a golden crust.
*   Once the crust forms, flip the chicken and add the remaining **1 tbsp ghee**.
*   Lower heat slightly and add **water** only if the pot looks very dry. You want a thick gravy, not a thin 
soup.
*   Let it simmer for 15-20 minutes until the chicken is cooked through but still juicy inside.

#### **4. The Vegetable Crunch**
*   In a separate pan, heat 1 tbsp of oil.
*   Fry the **bell pepper (capsicum) strips** on high heat with a splash of water if they are starting to 
shrink. You want them to char slightly at the edges but remain firm (Crisp-tender).
*   Remove the peppers from this pan and set aside. They will be added to the curry at the very end to keep that 
"restaurant crunch."
...
#### **6. Serving**
*   Garnish generously with chopped coriander and lemon wedges.
*   Serve immediately.
...
like a restaurant dish. The vinegar (or lime) cuts through the fat and spice, creating a "tang" that makes your 
jaw move.

**Serve with:**
*   Plain Basmati Rice (to absorb the spicy sauce).
*   Or crispy Naan.
*   Fresh Chutney (optional, but keep it simple to not mask the heat).
